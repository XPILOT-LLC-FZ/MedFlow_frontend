...
export const systemLogs: SystemLog[] = [
  ...
  { id: "log-2", action: "Appointment Created", user: "reception@clinic.com", role: "STAFF", timestamp: "2026-04-03T08:30:00", details: "New appointment created for John Smith with Dr. Mitchell", level: "info" },
  ...
  { id: "log-6", action: "Service Price Updated", user: "admin@clinic.com", role: "ADMIN", timestamp: "2026-04-03T10:00:00", details: "Cardiac Screening price updated from $400 to $450", level: "info" },
  ...
  { id: "log-9", action: "Inventory Restocked", user: "admin@clinic.com", role: "ADMIN", timestamp: "2026-04-02T14:00:00", details: "Surgical Gloves restocked - 250 boxes added", level: "info" },
