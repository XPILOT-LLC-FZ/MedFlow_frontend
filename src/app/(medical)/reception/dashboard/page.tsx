...
export default function ReceptionDashboard() {
  ...
  const refreshDashboard = React.useCallback(async () => {
    try {
      ...
      const patients = await patientService.getAll({ insuranceStatus: "pending" });
      // The backend now filters by insuranceStatus, but we keep the frontend filter 
      // as an extra layer of safety for data structure parsing.
